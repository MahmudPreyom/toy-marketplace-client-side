...
const Gallery = () => {
    ...
    return (
        <div>
            <h3 className="text-center font-bold text-4xl mb-2 mt-24 text-blue-900" data-aos="flip-up" data-aos-easing="ease-in-cubic"
                    data-aos-duration="2000">Car Gallery</h3>
